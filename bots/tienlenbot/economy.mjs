...
/// Một trăm vàng một điểm.
///
/// Chọn tròn để nhẩm được: phát một trăm nghìn là **một nghìn điểm**, và không ai phải mở bảng ra
/// mới biết mình sắp được bao nhiêu. Đây là con số **duy nhất** quy đổi giữa hai thứ ấy — điểm
/// không được cất riêng ở đâu cả, nó là tổng vàng đã phát chia cho đây, nên đổi con số này là
/// đổi cách đọc cả cái bảng chứ không phải viết lại lịch sử của ai. Người phát hôm qua và người
/// phát hôm nay vẫn so được với nhau, vì cả hai đều được đọc ra từ cùng một cột `gave`.
export const MERIT_PER = 100;
